...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-03-2025 a las 07:21:20
...
(2, 'DNI', '3358371741901', 'andre', 'Yucra', 'Moquegua', 'San Antonio', 'calle 20', '', 'a@gmail.com'),
(3, 'Otro', '0101010101', 'M UNO', 'ooo', 'hethrhc', 'bfghjklñ', 'cxcvb', '', '');
...
CREATE TABLE `empresa` (
  ...
  `empresa_foto` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
(1, 'uno jhj fgr sg', '7446468486', 'a@gmail.com', 'calle 20', 'X0Q9K5Z6H3-56.png');
...
(1, 'C0010', 'cafe', 0, 'Otro', 0.10, 3.50, '-', '-', 'Habilitado', 'C0010_39.jpg', 1),
(2, 'CA0010', 'americano', 7, 'Otro', 1.00, 3.00, 'n', 'm', 'Habilitado', 'CA0010_97.jpg', 1);
...
(1, 'Administrador', 'Principal', 'admin@admin.com', 'Administrador', '$2y$10$od1ZIIaCTLIYjxcTY6zHYugid/SDtxxf5Ev2goOkhxQ1HBQhUzYnW', 'Administrador', '', 1),
(2, 'andre', 'Yucra', '', 'AAAAAAAAAA', '$2y$10$KJSi4oYg2VN0m5aBPZymIO9ycWmo7OCOIQOjTjAprXj8/WB0Z30Uy', 'Cajero', 'andre_20.jpg', 2);
...
(2, 'F5I6F8P2A2-1', '2025-03-09', '10:56 pm', 3.50, 10.00, 6.50, 1, 1, 1),
(4, 'W4Y0V3V0B2-2', '2025-03-10', '12:50 am', 3.50, 3.50, 0.00, 1, 1, 1);
...
(2, 1, 0.10, 3.50, 3.50, 'cafe', 'F5I6F8P2A2-1', 1),
(4, 1, 0.10, 3.50, 3.50, 'cafe', 'W4Y0V3V0B2-2', 1);
