...
class userController extends mainModel {
    ...
    /*---------- Manejador de errores y respuestas JSON ----------*/
    ...
    private function fatalError($error_msg) {
    ...
    public function registrarUsuarioControlador(){
        try {
            ...
            if($nombre=="" || $apellido=="" || $usuario=="" || $clave1=="" || $clave2==""){
                ...
                return $this->jsonResponse($alerta);
                exit();
            }
    ...
    /*---------- Asegurarse que todos los métodos retornen JSON válido ----------*/
    public function __call($name, $arguments) {
        return $this->fatalError("Método no encontrado: $name");
    }
